...
cd REPOSITORY_NAME
```
<img src="Screenshots/3.1.png" alt="Clone the repository" style="border: 2px solid black;">
...
## 4. Running the Application Running with Docker
...
#### 5.1. Rebuild the Image for the AMD64 Architecture:
